...
| Stream | Description |
| --- | --- |
| [**CSE (Core)**](https://manipal.edu/mu/campuses/mahe-bengaluru/academics/institution-list/mitblr/program-list/btech/btech-computer-science-engineering.html)
[**Course Structure**](https://manipal.edu/content/dam/manipal/mu/maheblr/mitblr/documents/course-structures/course-structure-2022-years-onwards/B%20Tech%20CSE%202022%20course%20str%20(1).pdf) | It deals completely with the core of computer science, including the history of computers and their evolution. Cutoff-wise, it is ranked above all other streams. |
| [**CSE (Artifical Intelligence)**](https://manipal.edu/mu/campuses/mahe-bengaluru/academics/institution-list/mitblr/program-list/btech/BTech-Computer-Science-and-Engineering-Artificial-Intelligence-and-Machine-Learning.html)
[**Course Strcuture**](https://manipal.edu/content/dam/manipal/mu/maheblr/mitblr/documents/course-structures/course-structure-2022-years-onwards/B%20Tech%20CSE(AI)%20str%202022%20(1).pdf) | This stream is popular due to the recent growth of the AI industry. It covers the fundamentals of ML, along with neural networks and deep learning. |
| [**CSE (Data Science)**](https://manipal.edu/mu/campuses/mahe-bengaluru/academics/institution-list/mitblr/program-list/btech/btech-computer-science-data-science1.html)
[**Course Strcuture**](https://manipal.edu/content/dam/manipal/mu/maheblr/mitblr/documents/course-structures/updated-course-structure/BTech%20CSE%20(Data%20Science)%20Course%20Structure%202023.pdf) | This stream focuses on building data models in a statistical and analytical approach. The specialization syllabus can be quite intensive compared to others. |
| [**CSE (Cybersecurity)**](https://manipal.edu/mu/campuses/mahe-bengaluru/academics/institution-list/mitblr/program-list/btech/btech-computer-science-cyber-security.html)
[**Course Strcuture**](https://manipal.edu/content/dam/manipal/mu/maheblr/mitblr/documents/course-structures/course-structure-2022-years-onwards/Cyber%20Security-Course%20Structure%20-2022.pdf) | With the growth of the AI industry and data on the internet, the cybersecurity field is always in demand. It deals with networks and their different management/security systems. |
